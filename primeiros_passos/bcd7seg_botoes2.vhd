-- Arquivo: bcd7seg_botoes2.vhd
-- Descrição: Exibe nos 4 displays, o valor binário respetivo os botões
-- Autor: Malki-çedheq Benjamim
-- Data: 04/02/2022
LIBRARY IEEE;
USE IEEE.std_logic_1164.ALL;
ENTITY bcd7seg_botoes2 IS
...
END bcd7seg_botoes2;
ARCHITECTURE bhv OF bcd7seg_botoes2 IS
	--Sinais
	SIGNAL bcd : std_logic_vector (4 DOWNTO 1);
BEGIN
	
	--o número a ser exibido corresponde ao binário representado
	--pelos botões pressionados e não-pressionados
	...
	--ativa todos os dígitos são ativo-baixo!
	dig <= B"0000"; --controla os digitos ativos do display BCD
